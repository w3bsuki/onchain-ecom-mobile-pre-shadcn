            ...
            <div className="gap-2 grid grid-cols-3 pt-1">
              {sizes.map((size) => (
                <button
                  ...
                  key={size}
                  className={cn(
                    "border cursor-pointer flex font-medium h-10 items-center justify-center rounded text-sm transition-colors w-full",
                    selectedSizes.includes(size)
                      ? "bg-black border-black text-white hover:bg-zinc-800 hover:border-zinc-800"
                      : "border-zinc-200 bg-white text-gray-900 hover:border-gray-300 hover:bg-gray-50"
                  )}
